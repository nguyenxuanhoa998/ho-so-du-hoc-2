  ...
  return (
    <div className="min-h-screen bg-slate-900 text-white p-4 md:p-8">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Khu vực tìm kiếm */}
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 bg-slate-800 p-6 rounded-2xl mb-10 border border-slate-700 shadow-xl">
          ...
          <input placeholder="Email" className="bg-slate-700 p-3 rounded-lg outline-none focus:ring-2 focus:ring-yellow-500" onChange={e => setSearchData({...searchData, email: e.target.value})} />
